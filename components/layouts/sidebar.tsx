            ...
            >
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center flex justify-center">
                            <Image className="flex-none" src="/fidelity-bank-2.png" alt="logo" width = {200} height  ={100} />
                            {/* <span className="align-middle text-2xl font-semibold  dark:text-white-light lg:inline">FIDELITY</span> */}
                        </Link>
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            {/* <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 mt-10 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                            ...
                            <li className="nav-item mt-5">
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/verifications/initiate" className="group">
                                            <div className="flex items-center">
                                                <IconMenuNotes className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Start Verification')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    {/* <li className="nav-item">
                                        <Link href="/solutions" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Solutions')}</span>
                                            </div>
                                        </Link>
                                    </li> */}
                                    <li className="nav-item">
                                        <Link href="/verifications" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Manage Verifications')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    {/* <li className="nav-item">
                                        <Link href="/compliance" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Compliance')}</span>
                                            </div>
                                        </Link>
                                    </li> */}
                                </ul>
                            ...
                            <li className="menu nav-item">
                                <Link href="/tables" className="group">
                                    <div className="flex items-center">
                                        <IconMenuTables className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('API Keys')}</span>
                                    </div>
                                </Link>
                            </li> */}
                            {/* <li className="menu nav-item">
                            ...
                            <li className="menu nav-item">
                                <Link href="/support" className="group">
                                    <div className="flex items-center">
                                        <IconMenuTables className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('FAQs')}</span>
                                    </div>
                                </Link>
                            </li>
